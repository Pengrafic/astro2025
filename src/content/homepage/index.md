...
banner:
  ...
  image: /images/icono_pen.webp
  buttons:
    - label: Get the Code
      href: "https://github.com/Pengrafic"
      target: "_blank"
      icon: _GitHub
...
features:
  ...
  feature_list:
    ...
    - icon: "search" #icon package react-feather-icon [https://feathericons.com/]
      title: SEO Friendly
      content: Boost your site's visibility with <b class="text-text">built-in SEO optimizations</b>, including automatic sitemap generation using <a target='blank' href="https://github.com/Pengrafic/"><span class="text-accent font-bold underline">astrojs/sitemap</span></a>.
